  ...
  return (
    <div>
      ...
      <div className="text-[14px] lg:text-[16px] w-full lg:w-[60%] container text-center">
        ...
        <div className="bg-gray-600 text-[14px] lg:text-[16px] w-[90%] mx-auto text-white h-[60px] flex justify-center items-center rounded-md font-medium mb-[16px]">
          <p>
      ...
      <FaceBookParent>
        <p className="lg:text-[16px] text-[14px] w-[98%] lg:w-[60%] mx-auto mb-[16px]">
