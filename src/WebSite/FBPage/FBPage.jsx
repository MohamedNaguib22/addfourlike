  ...
  return (
    <div>
      ...
      <div className="w-[98%] lg:w-[60%] container text-center">
        <div className="bg-black text-white text-[14px] lg:text-[16px] h-[60px] flex justify-center items-center rounded-md font-medium mb-[16px]">
          <h1>
            For this section only - click the FOLLOW button if there is no LIKE
            button in the pop-up window
          </h1>
        </div>
        <div className="bg-gray-600 w-[90%] text-[14px] lg:text-[16px] mx-auto text-white h-[60px] flex justify-center items-center rounded-md font-medium mb-[16px]">
          <p>
      ...
      <FaceBookParent>
        <p className="lg:w-[60%] text-[14px] lg:text-[16px] mx-auto mb-[16px]">
